...
public class TricksterEntity extends SpellcastingIllagerEntity {
    ...
    private static final DataParameter<Optional<Vector3d>> PRISON_POS = EntityDataManager.defineId(TricksterEntity.class, SRCompat.OPTIONAL_VECTOR3D_SERIALIZER);
    private static final int chargeTime = 4;
    private static final int prisonTime = 60;
    private Set<Entity> trackedSpellEntities = new HashSet<>();
