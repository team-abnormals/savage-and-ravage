...
public class SRTiers {
	...
	public static final AbnormalsArmorMaterial MASK = new AbnormalsArmorMaterial(new ResourceLocation(SavageAndRavage.MOD_ID, "mask"), 5, new int[]{1, 1, 1, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> Ingredient.fromItems(Items.LEATHER));
}
