...
public class SRBlocks {
    ...
    public static final RegistryObject<Block> CHISELED_GLOOMY_TILES = HELPER.createBlock("chiseled_gloomy_tiles", () -> new ChiseledGloomyTilesBlock(SRProperties.LIGHTABLE_GLOOMY_TILES), ItemGroup.BUILDING_BLOCKS);
