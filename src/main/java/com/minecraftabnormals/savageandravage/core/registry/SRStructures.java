...
public class SRStructures {
    ...
    public static void registerPools() {
        ...
        JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(SavageAndRavage.MODID, "pillager_outpost/enclosure_plates"), new ResourceLocation("empty"), ImmutableList.of(Pair.of(new SingleJigsawPiece(SavageAndRavage.MODID + "pillager_outpost/enclosure"), 1), Pair.of(new SingleJigsawPiece("empty"), 5)), JigsawPattern.PlacementBehaviour.RIGID));
