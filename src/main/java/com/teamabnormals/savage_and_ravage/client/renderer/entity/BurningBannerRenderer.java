...
public class BurningBannerRenderer extends EntityRenderer<BurningBanner> {
	...
	@Override
	public void render(BurningBanner entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLightIn) {
	...
	private static void pos(VertexConsumer builder, Matrix4f matrix4f, double x, double y, double z, double rotation) {
		double[] rotatedVertices = BurningBanner.rotate(x, y, z, rotation);
	...
	@Override
	public ResourceLocation getTextureLocation(BurningBanner entity) {
