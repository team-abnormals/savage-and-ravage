...
public class SkeletonVillager extends AbstractSkeleton implements CrossbowAttackMob {
	private static final EntityDataAccessor<Boolean> DATA_CHARGING_STATE = SynchedEntityData.defineId(SkeletonVillager.class, EntityDataSerializers.BOOLEAN);
	private final ImprovedCrossbowGoal<SkeletonVillager> aiCrossBow = new ImprovedCrossbowGoal<>(this, 1.0D, 8.0F, 5.0D);
	private final MeleeAttackGoal aiMelee = new MeleeAttackGoal(this, 1.2D, false) {
		@Override
		public void stop() {
			super.stop();
			SkeletonVillager.this.setAggressive(false);
		}

		@Override
		public void start() {
			super.start();
			SkeletonVillager.this.setAggressive(true);
		}
	};
	...
	public SkeletonVillager(EntityType<? extends SkeletonVillager> type, Level worldIn) {
		super(type, worldIn);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, (new HurtByTargetGoal(this, SkeletonVillager.class)).setAlertOthers());
