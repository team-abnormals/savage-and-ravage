...
public class IceChunkEntity extends Entity implements IEntityAdditionalSpawnData {
	...
	public IceChunkEntity(EntityType<IceChunkEntity> entityType, Level world) {
		super(entityType, world);
	}

	public IceChunkEntity(Level world, @Nullable Entity caster, @Nullable Entity target) {
	...
	private void onImpactEntity(EntityHitResult result) {
		...
		if (entity instanceof LivingEntity) {
			((LivingEntity) entity).addEffect(new MobEffectInstance(SREffects.FROSTBITE.get(), 160, 0, false, false, true));
		}
	}
