package com.farcr.savageandravage.client;
 ...
 */
public class SRRenderTypes extends RenderState {
    public SRRenderTypes(String nameIn, Runnable setupTaskIn, Runnable clearTaskIn) {
