package com.farcr.savageandravage;

import com.farcr.savageandravage.core.SRHooks;
...
public class FlintAndSteelItem extends Item {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (isUnlitCampfire(blockstate)) {
            ...
            if (canSetFire(iworld.getBlockState(blockpos1), iworld, blockpos1)&& SRHooks.isBlockNotOminousBanner(blockpos,context.getWorld())) {
