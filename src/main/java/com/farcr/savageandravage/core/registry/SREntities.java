...
public class SREntities {
    ...
    public static RegistryObject<EntityType<CreeperSporeCloudEntity>> CREEPIE_SPORE_CLOUD = ENTITIES.register("creepie_spore_cloud", () -> EntityType.Builder.<CreeperSporeCloudEntity>create(CreeperSporeCloudEntity::new, EntityClassification.MISC).size(0.6F, 1.99F).build("savageandravage:creepie_spore_cloud"));
    @OnlyIn(Dist.CLIENT)
